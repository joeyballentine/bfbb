...
void bungee_state::insert_animations(xAnimTable& at)
{
    ...
    xAnimTableNewState(&at, "bungee_dive_0", 0, 0, 1.0f, 0, 0, 0.0f, 0, 0, xAnimDefaultBeforeEnter, 0, 0);
    ...
    shared.anim_tran.hit = xAnimTableNewTransition(&at, "bungee_cycle_0 bungee_dive_0 bungee_top_0 bungee_bottom_0", "bungee_hit_0", 0, 0, 0x10, 0, 0.0f, 0.0f, 0, 0, fixed.hit_anim_time, 0);
