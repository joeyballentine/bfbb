...
//
// Neither is wrong. But nothing at RwRasterLock says which one a build is, so
// anything filling a raster itself has to ask, and this is where it asks.
...
#define IRASTERFILL_ROWS_BOTTOM_UP 1

#define IRASTERFILL_RED 0
#define IRASTERFILL_BLUE 2

#else

#define IRASTERFILL_ROWS_BOTTOM_UP 0

#define IRASTERFILL_RED 2
#define IRASTERFILL_BLUE 0
