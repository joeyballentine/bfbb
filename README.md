...
| Mod folder | `[assets] mod` | Point it at an Xbox mod's files. They are read in place of the originals at the same path, so the asset folder stays unmodified. GameCube packages are skipped for now. |
