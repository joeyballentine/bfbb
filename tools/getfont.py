...
soft. `[font] face` points at an outline to draw the same letterforms from
...
own. Any .ttf works, and a wrong one costs nothing -- set [font] face back to
...
def main():
    ...
    print()
    print("    [font]")
    print("    face = {}".format(path.replace("\\", "/")))
    return 0
