...
config.libs = [
    ...
    mslLib(
        ...
        [
            ...
            Object(NonMatching, "MSL_C/MSL_Common/alloc.c", extra_cflags=["-inline deferred"]),
            Object(NonMatching, "MSL_C/MSL_Common/ansi_files.c"),
            Object(NonMatching, "MSL_C/MSL_Common_Embedded/ansi_fp.c", extra_cflags=["-inline deferred"]),
            ...
            Object(NonMatching, "MSL_C/MSL_Common/direct_io.c", extra_cflags=["-inline deferred"]),
            Object(Matching, "MSL_C/MSL_Common/errno.c"),
            Object(NonMatching, "MSL_C/MSL_Common/file_io.c", extra_cflags=["-inline deferred"]),
            Object(Matching, "MSL_C/MSL_Common/FILE_POS.C", extra_cflags=["-inline deferred"]),
            Object(Matching, "MSL_C/MSL_Common/locale.c"),
            Object(NonMatching, "MSL_C/MSL_Common/mbstring.c", extra_cflags=["-inline deferred"]),
            Object(Matching, "MSL_C/MSL_Common/mem.c", extra_cflags=["-inline deferred"]),
            Object(Matching, "MSL_C/MSL_Common/mem_funcs.c", extra_cflags=["-inline deferred"]),
            Object(NonMatching, "MSL_C/MSL_Common/misc_io.c", extra_cflags=["-inline deferred"]),
            Object(NonMatching, "MSL_C/MSL_Common/printf.c", extra_cflags=["-inline deferred"]),
            Object(NonMatching, "MSL_C/MSL_Common/qsort.c"),
            Object(Matching, "MSL_C/MSL_Common/rand.c"),
            Object(NonMatching, "MSL_C/MSL_Common/scanf.c", extra_cflags=["-inline deferred"]),
            Object(Matching, "MSL_C/MSL_Common/signal.c"),
            Object(NonMatching, "MSL_C/MSL_Common/string.c", extra_cflags=["-inline deferred"]),
            Object(NonMatching, "MSL_C/MSL_Common/strtold.c"),
            Object(NonMatching, "MSL_C/MSL_Common/strtoul.c", extra_cflags=["-inline deferred"]),
    ...
    trkLib(
        ...
        [
            ...
            Object(Matching, "debugger/embedded/MetroTRK/Portable/nubevent.c", extra_cflags=["-inline deferred"]),
    ...
    mslLib(
        ...
        [],
        [
            Object(NonMatching, "MSL_C/MSL_Common/extras.c", extra_cflags=["-inline deferred"])
        ]
    ),
    RenderWareLib(
        "rpcollis",
