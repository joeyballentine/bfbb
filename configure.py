...
config.libs = [
    ...
    mslLib(
        ...
        [
            ...
            Object(NonMatching, "MSL_C/MSL_Common/FILE_POS.C", extra_cflags=["-inline deferred"]),
            ...
            Object(NonMatching, "MSL_C/MSL_Common/mem_funcs.c", extra_cflags=["-inline deferred"]),
    ...
    trkLib(
        ...
        [
            ...
            Object(NonMatching, "debugger/embedded/MetroTRK/Portable/nubevent.c", extra_cflags=["-inline deferred"]),
